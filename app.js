...
class UI {
    ...
    diplayCartItems(item) {
        ...
        div.id = `${item.id}`
        div.innerHTML = `<img src=${item.image} class="my-item-img" alt="my item image">
        <div>
            <h4>${item.title}</h4>
            <h5>${item.price}</h5>
        ...
        <div>
            <img src="./chevron-up-solid.svg" class="fas fa-chevron-up" data-id=${item.id} alt="">
            <p class="item-amount">${item.amount}</p>
            <img src="./chevron-down-solid.svg" class="fas fa-chevron-down" data-id=${item.id} alt="">
        </div>`;
